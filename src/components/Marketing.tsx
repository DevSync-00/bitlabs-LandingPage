...
export function PageHero({ eyebrow, title, intro }: { eyebrow: string; title: string; intro: string }) {
  return <section className="hero-panel relative text-white"><div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-10 lg:py-28"><p className="eyebrow text-lime">{eyebrow}</p><div className="mt-6 grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end"><h1 className="max-w-4xl text-[clamp(2.8rem,5.5vw,5rem)] font-semibold leading-[1] tracking-[-.055em]">{title}</h1><p className="max-w-xl text-base leading-7 text-slate-300 lg:pb-1">{intro}</p></div></div></section>;
}
