...
export function Footer() {
  return <footer className="bg-[#081b15] text-white"><div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
    <div className="grid gap-12 border-b border-white/15 pb-14 md:grid-cols-2 lg:grid-cols-5">
      <div className="lg:col-span-2"><Link to="/" className="flex items-center gap-3"><Logo height={30} /><span className="text-lg font-semibold">BitLabs</span></Link><p className="mt-5 max-w-sm text-sm leading-6 text-slate-400">Technology teams and services that help ambitious organisations build, scale, and operate with confidence.</p></div>
