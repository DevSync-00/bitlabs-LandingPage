...
function Resources() {
  ...
  return <div className="bg-white dark:bg-white">
    <PageHero eyebrow="The BitLabs blog" title="Useful ideas from products we have actually built." intro="Practical notes on mobile product development, healthtech, cybersecurity and developer infrastructure—written from the work, not from theory." />
